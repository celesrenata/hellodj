"""AudioVis spectrum/waveform analyzer — server-rendered.

When fully implemented, this engine will render detailed spectrum analysis
and waveform displays. It combines FFT spectrum bars, scrolling waveform,
and frequency-domain waterfall plots into a single unified visualizer.
...
class AudioVisEngine(VisualizerRenderer):
    """AudioVis spectrum/waveform analyzer — server-rendered (stub).

    This engine will render spectrum analysis and waveform displays.
    Currently raises NotImplementedError on render_frames().
    """
    ...
    async def render_frames(self) -> AsyncIterator[bytes]:
        ...
        raise NotImplementedError("Engine 'audiovis' is not yet implemented")
